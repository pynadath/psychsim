...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:221|%
\end{flushleft}%
\subsubsection{Default change in Actor's alive}%
\label{ssubsec:Default change in Actor's alive}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:507|%
\linebreak%
IF %
\textbf{Actor's alive}%
\linebreak%
...
\end{description}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:172|%
\end{flushleft}

%
\subsection{Actor's categoryData}%
\label{subsec:Actor's categoryData}%
Information received from explicit seeking%
\begin{description}%
\item[Type:]%
Integer%
\end{description}%
\includegraphics[width=\textwidth]{images/categoryDataOfActor.png}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:743|%
\end{flushleft}%
\subsubsection{Observation function of Actor's categoryData when Actor{-}seekInfoReHurricane}%
\label{ssubsec:Observation function of Actor's categoryData when Actor{-}seekInfoReHurricane}%
\begin{flushleft}%
$\mbox{\textbf{Actor's categoryData}} '$%
$\leftarrow$%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:246|%
\end{flushleft}%
\subsubsection{Effect of Actor on Actor's childrenHealth}%
\label{ssubsec:Effect of Actor on Actor's childrenHealth}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:496|%
\linebreak%
IF %
\textbf{Actor's alive}%
\linebreak%
...
\end{description}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:157|%
\end{flushleft}
...
\end{description}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:143|%
\end{flushleft}
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:105|%
\end{flushleft}
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:282|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/system.py:55|%
\linebreak%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:225|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:443|%
\linebreak%
$\mbox{\textbf{Actor's location}} '$%
$\leftarrow$%
\textbf{Region01}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:433|%
\linebreak%
$\mbox{\textbf{Actor's location}} '$%
$\leftarrow$%
\textbf{shelter1}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:703|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:697|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:737|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:690|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:731|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:537|%
\linebreak%
IF %
\textbf{Actor's alive}%
\linebreak%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:542|%
\linebreak%
$\mbox{\textbf{Actor's resources}} '$%
$\leftarrow$%
0\%%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:593|%
\linebreak%
$\mbox{\textbf{Actor's resources}} '$%
$\leftarrow$%
80\%%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:270|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:600|%
\linebreak%
IF %
\textbf{Nature's phase}%
$=$%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:466|%
\linebreak%
IF %
\textbf{Actor's alive}%
\linebreak%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:570|%
\linebreak%
IF %
\textbf{Group's \_\_ACTION\_\_}%
$=$%
...
%
\subsubsection{Effect of Group{-}decreaseRisk on Region01's risk}%
\label{ssubsec:Effect of Group{-}decreaseRisk on Region01's risk}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/group.py:37|%
\linebreak%
$\mbox{\textbf{Region01's risk}} '$%
$\leftarrow$%
80\%%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/create.py:48|%
\end{flushleft}%
...
\end{description}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:769|%
\end{flushleft}

%
\subsection{Actor marriedTo Actor}%
\label{subsec:Actor marriedTo Actor}%
\begin{description}%
\item[Type:]%
Boolean%
\end{description}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:119|%
\end{flushleft}
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/group.py:94|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:361|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:343|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/group.py:109|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/group.py:120|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:350|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:333|%
\end{flushleft}%
...
%
\subsection{Actor seekInfoReHurricane None}%
\label{subsec:Actor seekInfoReHurricane None}%
\includegraphics[width=\textwidth]{images/Actor-seekInfoReHurricane.png}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:427|%
\end{flushleft}%
\subsubsection{Applicability of Actor seekInfoReHurricane None}%
\label{ssubsec:Applicability of Actor seekInfoReHurricane None}%
\begin{flushleft}%
IF %
\textbf{Actor's alive}%
\linebreak%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:293|%
\end{flushleft}%
...
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/actor.py:396|%
\end{flushleft}%
...
%
\subsection{Group decreaseRisk None}%
\label{subsec:Group decreaseRisk None}%
\includegraphics[width=\textwidth]{images/Group-decreaseRisk.png}%
\begin{flushleft}%
\verb|psychsim/domains/groundtruth/simulation/group.py:31|%
\end{flushleft}%
\subsubsection{Effect on Region01's risk of Group decreaseRisk None}%
\label{ssubsec:Effect on Region01's risk of Group decreaseRisk None}%
\begin{flushleft}%
$\mbox{\textbf{Region01's risk}} '$%
$\leftarrow$%
80\%%
