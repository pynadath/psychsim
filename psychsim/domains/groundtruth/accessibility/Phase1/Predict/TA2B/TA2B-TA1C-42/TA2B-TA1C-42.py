...
if __name__ == '__main__':
    ...
    for instance in range(3,6):
        ...
        assert participant == requested[instance-3]
        ...
        with open(os.path.join(os.path.dirname(__file__),'Instances','Instance%d' % (instance),'Runs','run-0','TA2B-TA1C-34.tsv'),'w') as csvfile:
