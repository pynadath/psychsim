...
if __name__ == '__main__':
    parser = accessibility.createParser(output='TA2A-TA1C-0102-RR.tsv',seed=True)
    ...
    demos = accessibility.readDemographics(data,last=82)
    hurricanes = accessibility.readHurricanes(args['instance'],args['run'])
    output = []
    names = {name for name in demos if demos[name]['Residence'] in {'Region05'}}
