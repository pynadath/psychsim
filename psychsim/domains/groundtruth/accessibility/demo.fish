...
python3 ethnographic.py 21 -r 2 --samples 2 --seed 1

echo "7. Information soliciting task"
python3 solicit.py 21 -r 2 --samples 10 --seed 1

echo "8. Information flow data"
python3 flow.py 21 -r 2 --samples 10 --seed 1

echo "9. Interaction data"
python3 interaction.py 21 -r 2 --samples 20 --seed 1

echo "10. Event journal"
python3 journal.py 21 -r 2 --samples 1 --seed 1

echo "11. Passive data collection"
python3 passive.py 21 -r 2 --day 90 Casualties

echo "12. Laboratory experiment"
python3 laboratory.py 21 -r 2 --samples 1 --seed 1
