...
#
# $Id: fsa.py 2455 2007-03-02 00:23:07 +0000 (Fri, 02 Mar 2007) pynadath $
...
import math
from bigwidgets import *
from teamwork.shell.PsychShell import *

#from teamwork.examples.PsychSim.PsychScenario import *
...
class GraphEdgeWidget(CanvasWidget):
    ...
    def _line_coords(self, (startx, starty), (endx, endy)):
        ...
        if (x1, y1) == (x2, y2):
            ...
            # Adjust endpoints so they end at the node perimeter.
